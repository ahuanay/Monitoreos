<?php
	...
	$resultProy = $get->getSP("get_ProyectosSeguidosxIdUsuario('".$_SESSION['usuario'][0]['IdUsuario']."')");
?>
...
<head>
	...
	<title>Seguiento de proyectos de municipalidades</title>
...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Proyectos seguiendo de municipalidades</h1>
					</div>
					<div class="row">
					<div class="col-xl-12">
	...
	<script src="js/seguir-muni.js"></script>
</body>
</html>
