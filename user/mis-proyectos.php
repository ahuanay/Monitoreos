<?php
	...
	require 'php/get.php';
	$get = new get();
	$resultProy = $get->getSP("get_ProyectosxIdUsuario('".$_SESSION['usuario'][0]['IdUsuario']."')");
?>
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Mis Proyectos de Inversión Pública</h6>
								</div>
								<div class="card-body">
