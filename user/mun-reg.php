                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="font-weight-bold text-primary text-uppercase mb-1"><?php echo $row['RazonSocial']; ?></div>
                                                <div class="mt-4 mb-0 text-gray-800">
                                                    <div class="text-info font-weight-bold">RUC:</div>
                                                    <?php echo $row['IdMunicipalidad']; ?>
                                                    <div class="text-info font-weight-bold">Direccion:</div>
                                                    <?php echo $row['Direccion']; ?>
                                                    <div class="text-info font-weight-bold">Alcalde:</div>
                                                    <?php echo $row['Alcalde']; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
